<template>
	<div class="d-flex w-100 h-100">
		<v-row class="w-100 h-100 px-5" v-if="!mobile">
			<v-col cols="4">
				<div
					class="w-100 h-100 d-flex justify-center align-center flex-column text-teal-lighten-1 text-center text-h2"
				>
					...
					<div class="text-h5 text-teal-lighten-2">
						...
						See where all you have visited on the map so that its easier to find photos.
					</div>

					<v-btn
						data-qa-id="start-creating-btn"
						class="ma-5"
						variant="outlined"
						append-icon="mdi-chevron-right"
						@click="onClickStartCreating"
					>
						Start Creating
					</v-btn>
				</div>
			...
			<v-col cols="8">
				<div class="w-100 h-100 d-flex align-center justify-center">
					<v-img :src="world_map"> </v-img>
				</div>
			</v-col>
		</v-row>
		<div
			v-else
			class="d-flex flex-column w-100 h-100 mx-5 align-center text-teal-lighten-1 text-center"
		>
			<div class="w-100">
				<v-img :src="world_map"></v-img>
			</div>
